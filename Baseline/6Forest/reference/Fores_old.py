...
from useless.germinate_data_old import random_gernerate_old
...
import sys
sys.path.append("..")
from Aliases.Alias_Prefix import *
...
def generate_test(input,sub_output,budget,output):
    ...
    if len(test_data)<1:
        ...
        return scan_addr(sub_output,filename)
