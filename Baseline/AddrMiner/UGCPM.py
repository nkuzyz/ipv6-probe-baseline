...
def optimization(all_pattern, hmax=16.0):
    ...
    import pickle
    with open("Baseline/AddrMiner/pk_data/reduced_pattern.pk","wb") as f:
...
def mppMiming(multi_level,algorithm="louvain",sst=1e7,hmin=14.0):
    ...
    with open("Baseline/AddrMiner/pk_data/lsp.pk","wb") as f:
        pickle.dump(lsp,f)
    most_popular = '0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0'
    low_p = []
    ...
    with open("Baseline/AddrMiner/pk_data/matrix.pk","rb") as f:
        matrix = pickle.load(f)
    
    with open("Baseline/AddrMiner/pk_data/reduced_pattern.pk","rb") as f:
    ...
    with open("Baseline/AddrMiner/pk_data/good_dis_p.pk","wb") as f:
...
if __name__ == "__main__":
    ...
    sst = 1e7
    # load data
    seeds_path = "Baseline/AddrMiner/data/seeds.csv"
    ipasn_path = "Baseline/AddrMiner/data/ipasn.dat"
    ...
    with open("Baseline/AddrMiner/pk_data/matrix.pk","wb") as f:
