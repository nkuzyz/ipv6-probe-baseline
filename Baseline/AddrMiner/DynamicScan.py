...
def Start():
    ...
    # num = [100]
    num = [5000]
    # args.input = 'Baseline/AddrMiner/seeds-S.txt'
    # args.output = 'Baseline/AddrMiner/result'
    args.input = 'Baseline/Database/dataset3.txt'
    args.output = 'Baseline/AddrMiner/dateset3'
    # args.input = 'Baseline/Database/dataset2.txt'
    # args.output = 'Baseline/AddrMiner/dateset2'
    ...
    # print(args.input)
    print("begin to get ipv6 address")
    ...
    for budget in budgets:
        print("begin generate and scan "+str(budget))
        output_dir = args.output + '/su_{}'.format(budget)
        R, target_len, result_len, hit_rate = DynamicScan(root, budget, args.IPv6, output_dir)
        
        f = open(output_dir+'/hit_rate.txt', 'w')
        f.write(str(hit_rate)+'\n')
        f.write(str(target_len)+'\n')
        f.write(str(result_len)+'\n')
        f.close()
