from Graph import Start,generate_test
import sys,os,re,time
from AliasScanG import *
...
output = "Baseline/6Graph/dataset3/"

# input ='Baseline/Database/few_data_500'
# output = "Baseline/6Graph/output_test/total_01"


Start(input,output)
print('greph pattern ready')
